    ...
    <Container className="py-16 sm:py-24">
      <div className="metal mx-auto max-w-md rounded-3xl p-8">
        ...
        <p className="mt-2 text-sm text-muted">
          Keep your saved roles, your profile and your resume in one place.
        </p>

        <div className="mt-7">
          <Suspense fallback={<div className="h-12 rounded-full bg-white/5" />}>
        ...
        <p className="mt-6 flex items-start gap-2 text-xs leading-relaxed text-subtle">
          ...
          <span>
            ...
            everything in it at any time. See our <a href="/privacy" className="underline underline-offset-2">privacy notice</a>.
          </span>
        </p>
      </div>
    </Container>
