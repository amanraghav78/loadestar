        ...
        return (
          <li key={d} className="flex">
            <Link
              ...
              className="metal-card group flex flex-1 items-center gap-4 rounded-2xl p-4 sm:p-5"
            >
              <span className="metal flex size-11 shrink-0 items-center justify-center rounded-xl">
                <Icon
                  className="text-silver size-5 transition-transform duration-300 group-hover:scale-110"
                  aria-hidden
                />
              </span>
              <span className="min-w-0 flex-1">
                <span className="text-fg block text-sm font-semibold sm:text-[15px]">{DISCIPLINE_LABEL[d]}</span>
                <span className="text-subtle block text-xs tabular-nums">
                  {numberFormat.format(count)} {count === 1 ? "job" : "jobs"}
                </span>
              </span>
              <ArrowUpRight
                className="text-subtle group-hover:text-fg hidden size-4 shrink-0 transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5 sm:block"
                aria-hidden
              />
            </Link>
          </li>
