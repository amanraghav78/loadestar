...
const TAGS: Array<[string, RegExp]> = [
  ...
  // Named technologies people list on a resume and employers ask for by name.
  // Deliberately no generic process words ("Git", "Agile", "REST"): almost every
  // posting mentions them, and they would crowd the six tags a job card shows.
  ...
  ["GitLab CI", /\bGitLab ?(?:CI|CI\/CD)\b/i],
  ["Helm", /\bHelm\b/],
  ["Argo CD", /\bArgo ?CD\b/i],
  ["Linux", /\bLinux\b/i],
  ["Cypress", /\bCypress\b/],
